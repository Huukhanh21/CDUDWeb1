...
<body>
    ...
    <header class="header">
        <div class="container">
            <img class="logo" style="width: 100px;" src="https://inkythuatso.com/uploads/images/2021/11/logo-mercedes-inkythuatso-3-01-11-09-10-56.jpg" alt="logo">
            <nav class="menu">
                <ul>
                    <li><a href="#">Đăng nhập <i class="fa-solid fa-right-to-bracket"></i></a></li>
                    <li><a href="#">Giỏ hàng <i class="fas fa-cart-shopping"></i></a></li>
...
<article class="gallery-wrap"> 
	<div class="img-big-wrap">
	  <div> <a href="#"><img src="images/products/jacket-1.jpg"></a></div>
	</div> <!-- slider-product.// -->
	<div class="thumbs-wrap">
	  <a href="#" class="item-thumb"> <img src="images/products/jacket-1.jpg"></a>
	  <a href="#" class="item-thumb"> <img src="images/products/jacket-2.jpg"></a>
	  <a href="#" class="item-thumb"> <img src="images/products/jacket-3.jpg"></a>
	  <a href="#" class="item-thumb"> <img src="images/products/jacket-4.jpg"></a>
	</div> <!-- slider-nav.// -->
...
<footer class="section-footer bg-secondary">
  <div class="container">
    ...
    <section class="footer-bottom text-center">
        ...
        <p class="text-muted"> &copycopyright</p>
        <br>
    </section>
  </div><!-- //container -->
</footer>
